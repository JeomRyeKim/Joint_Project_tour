...
<%-- <div class="planL-navbox__long">
	...
	<div class="container" style="background: linear-gradient(to right, #fffaf7, #fff5f3);">
	...
	<form action="/wishListSearch" method="post"  style="margin-top: 100px; margin-left: 30px;">
