    ...
    <div class="input-form-backgroud row">
      <div class="input-form col-md-6" style="margin-left: 25%; background: linear-gradient(to right, #fffaf7, #fff5f3);">
        ...
        <form class="validation-form"  method="post">
          ...
          <div class="mb-4"></div>
          <button class="btn text-white btn-lg btn-block" style=" background: linear-gradient(to right, #75CFB8, #BBDFC8); float: left;" onclick="check()">회원정보수정</button>
        </form>
        <button class="btn btn-danger btn-lg btn-block" style="float: right;" onclick="location.href='/member/leave?m_id=${member.m_id}'">회원탈퇴하기</button>
      </div>
     </div>
  </div>
