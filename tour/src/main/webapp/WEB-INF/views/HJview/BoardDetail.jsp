...
<c:choose>
  <c:when test='${b_like_check == "y"}'> <!-- 좋아요O 사람에게 보이는 이미지 : 회원 -->
    <a href="javascript:like_func();" style="text-decoration:none">
      <img src='image/like/heart_like.png' id="like_img" class="likeImage" width="15" height="auto">
    ...
    <c:otherwise> <!-- 좋아요X 사람에게 보이는 이미지 : 회원 or 비회원 -->
      <a href="javascript:like_func();" style="text-decoration:none">
        <img src='image/like/heart_dislike.png' id="like_img" class="likeImage" width="15" height="auto">
        <input type="text" id="b_like_cnt" style="border:none;" value="${boardDetail.b_like_cnt}" readonly>
      </a> 
    </c:otherwise>
</c:choose> 
